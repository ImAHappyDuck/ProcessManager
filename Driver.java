public class Driver {
    public static void main(String[] args) {
        // TODO: figure out how to get a ProcessManager Instance
...
ProcessManager manager = ProcessManager.getInstance();
        ...
        System.out.println("the following line should say: 1 2 3 4 5 6");
        manager.shortPrint();
        manager.process(40);
        System.out.println("the following line should say: 5 6 1 3 4");
        manager.shortPrint();
        p4.openFile("file1");
        p4.openFile("file2");
        p5.openFile("anotherfile");
        System.out.println();
        System.out.println("in the following lines, p1, p3 and p4 should have 10ms less time than original");
        ...
        System.out.println();
        System.out.println("the following line should say: 6 4 7 5");
        manager.shortPrint();
        p4.closeFile("file2");
        ...
        System.out.println("there should be 4 processes, p8 should show TERMINATED state");
