...
public class ReadyQueueTester {
    ...
    public void bigTest() throws Exception {
        ...
        rq1.addProcess(new Process(4,"test", 222));
    ...
    @Test
    public void addAtEnd2() throws Exception {
        ReadyQueue rq1 = new ReadyQueue();
        rq1.addProcess(new Process(5,"test", 222));
        rq1.addProcess(new Process(7,"test", 222));
        assertEquals(2,rq1.getNumProcesses());
    ...
    @Test
    public void removeProcess2() throws Exception {
        ReadyQueue rq1 = new ReadyQueue();
        try {
            rq1.removeProcess();
            fail();
    ...
    @Test
    public void contextSwitchTest2() throws Exception {
        ReadyQueue rq1 = new ReadyQueue();
        rq1.addProcess(new Process(5,"test", 222));
        rq1.addProcess(new Process(7,"test", 222));
        assertEquals(5, rq1.getFirst().getPid());
